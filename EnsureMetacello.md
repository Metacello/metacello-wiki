As of [1.0-beta.27](http://code.google.com/p/metacello/wiki/10betaVersionDescriptions#1.0-beta.27).
...
See also [#bootstrapPackage:from:](BootstrapPackageFrom.md) for additional implementation details.